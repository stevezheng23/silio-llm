...
mv ${OUTPUTDIR}/classification_report.txt ${OUTPUTDIR}/optimal_classification_report.txt
mv ${OUTPUTDIR}/confusion_matrix.png ${OUTPUTDIR}/optimal_confusion_matrix.png
...
python ./src/register_model.py --model_dir=./tmp/model/pytorch
